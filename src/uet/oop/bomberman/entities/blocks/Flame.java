...
public class Flame extends Entity {
    ...
    public static void fireFlame(int x, int y) {
        ...
        flamecenter.setImg(Sprite.movingSprite(Sprite.bomb_exploded, Sprite.bomb_exploded1, Sprite.bomb_exploded2, countToExploded, decayTimer).getFxImage());
        ...
        if (canFireUp(x, y)) {
            ...
            flameup.setImg(Sprite.movingSprite(Sprite.explosion_vertical,
                    Sprite.explosion_vertical1, Sprite.explosion_vertical2, countToExploded, decayTimer).getFxImage());
        }
        if (canFireDown(x, y)) {
            ...
            flamedown.setImg(Sprite.movingSprite(Sprite.explosion_vertical_down_last,
                    Sprite.explosion_vertical_down_last1, Sprite.explosion_vertical_down_last2, countToExploded, decayTimer).getFxImage());
        }
        if (canFireLeft(x, y)) {
            ...
            flameleft.setImg(Sprite.movingSprite(Sprite.explosion_horizontal_left_last,
                    Sprite.explosion_horizontal_left_last1, Sprite.explosion_horizontal_left_last2, countToExploded, decayTimer).getFxImage());
        ...
        if (canFireRight(x, y)) {
            ...
            flameright.setImg(Sprite.movingSprite(Sprite.explosion_horizontal_right_last,
                    Sprite.explosion_horizontal_right_last1, Sprite.explosion_horizontal_right_last2, countToExploded, decayTimer).getFxImage());
